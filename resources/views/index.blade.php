...
<body>
    ...
    <section class="our-journey">
        ...
        <section class="outer-section">
            <div class="main-card">
                <div class="left-part">
                    <h1>WorFlik helps businesses work smarter and grow stronger.</h1>
                    <p>
                    ...
                    <a class="inside-trial" href="#">Start Your Free Trial</a>
                </div>

                <div class="right-part">
                    <div class="scroll-track">
                        <div class="mini-card mini-card-1">Clarity at a Glance</div>
                        <div class="mini-card mini-card-2">Security by Design</div>
                        <div class="mini-card mini-card-3">Built to Scale</div>
            ...
            <div class="scroll-window">
                <div class="scroll-track">
                    ...
                    <div class="testimonial-card">
                        ...
                        <div class="profile">
                            <img src="/img/ceo1.jpg" alt="Profile">
                    ...
                    <div class="testimonial-card">
                        <div class="stars">★★★★★</div>
                        <p class="review">
                            "WorFlik completely streamlined our operations. Managing accounting, HR, and inventory in
                            one
                            secure platform has saved us time, reduced errors, and cut costs. It’s the smartest
                            business."
                        </p>
                        <div class="profile">
                            <img src="/img/ceo2.jpg" alt="Profile">
                            <div class="profile-info">
                                <h1>Martin Karen</h1>
                                <span>High Tec CEO</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="testimonial-card">
                        <div class="stars">★★★★★</div>
                        <p class="review">
                            "WorFlik brought clarity and control to our daily operations. Having accounting, HR, and
                            inventory in one place has improved our productivity and given us peace of mind."
                        </p>
                        <div class="profile">
                            <img src="/img/ceo3.jpg" alt="Profile">
                            <div class="profile-info">
                                <h1>Mark Atom</h1>
                                <span>TORQUE CEO</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="testimonial-card">
                        ...
                        <p class="review">
                            "WorFlik completely streamlined our operations. Managing accounting, HR, and inventory in
                            one secure platform has saved us time, reduced errors, and cut costs. It’s the smartest
                            business."
                        </p>
                        <div class="profile">
                            <img src="/img/ceo2.jpg" alt="Profile">
